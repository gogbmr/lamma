    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-background relative transition-colors duration-300">
      ...
      <Card className="w-full max-w-md shadow-xl border border-border bg-card text-card-foreground rounded-2xl overflow-hidden">
        <div className="bg-primary/5 p-6 text-center border-b border-border/50">
          ...
          <p className="text-xs text-muted-foreground mt-1 font-medium">Learn. Trade. Master the Markets.</p>
        </div>

        <CardHeader className="space-y-1 text-center pt-">
          <CardTitle className="text-xl font-extrabold tracking-tight">Create your account</CardTitle>
          <CardDescription className="text-xs text-muted-foreground">
            Let's start you Finance journy today.
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="John Doe" className="h-10 text-sm rounded-xl focus-visible:ring-primary" {...field} />
                      </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="johndoe99" className="h-10 text-sm rounded-xl focus-visible:ring-primary" {...field} />
                      </FormControl>
                      <FormMessage className="text-[11px]" />
                    </FormItem>
                  )}
          ...
          <div className="pt-2 text-center text-xs text-muted-foreground">
            ...
            <a href="/login" className="underline font-bold text-primary hover:opacity-80 transition-opacity">Log in</a>
          </div>
        </CardContent>
      </Card>
    </div>
